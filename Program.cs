...
builder.Services.AddSingleton<IDataVisibilityPolicy, JobVisibilityPolicy>();
builder.Services.AddSingleton<IDataVisibilityFilterBuilder, DataVisibilityFilterBuilder>();
